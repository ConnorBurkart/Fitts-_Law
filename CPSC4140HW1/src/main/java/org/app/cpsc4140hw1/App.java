...
public class App extends javafx.application.Application {
    ...
    private void displayRandomCircle(BorderPane root) {
        ...
        // Random position within the window, ensuring the entire circle is visible
        double randomX = circleRadius + Math.random() * (windowWidth - 2 * circleRadius);
        double randomY = circleRadius + Math.random() * (windowHeight - 2 * circleRadius);
